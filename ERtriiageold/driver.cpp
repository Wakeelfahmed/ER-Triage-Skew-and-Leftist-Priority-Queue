...
int main() {
	...
	mypatients[3].setPatient("Addie Greer", 39, 98, 38, 143, 9);
	mypatients[4].setPatient("Erika Drake", 36, 87, 27, 99, 1);
	mypatients[5].setPatient("Lachlan Solomon", 40, 99, 39, 85, 5);
	mypatients[6].setPatient("Ismail Carter", 42, 85, 25, 98, 2);
	mypatients[7].setPatient("Tatiana Buckley", 36, 79, 19, 79, 10);
	mypatients[8].setPatient("Tatiana Buckley", 36, 95, 35, 70, 10);
	mypatients[9].setPatient("Ismail Carter", 40, 99, 39, 110, 1);

	for (int i = 0; i < 10; i++)
		aQueue.insertPatient(mypatients[i]);
